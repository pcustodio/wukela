...
//            let resource = ImageResource(downloadURL: (URL(string: newsSync[indexPath.row][2] as! String ) ??  URL(string:"https://wukela.app/assets/empty@3x.png"))!, cacheKey: newsSync[indexPath.row][2] as? String)
